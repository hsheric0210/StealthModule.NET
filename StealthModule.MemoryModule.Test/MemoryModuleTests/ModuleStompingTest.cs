...
{
    [TestClass]
    public class ModuleStompingTest
    {
        ...
        private static void TestManualMap(string dllName)
        {
            ...
            var mapped = new ModuleStomping(dllBytes);
            Logger.LogMessage("The dll {0} successfully overwritten the address {1} (where originally {2} was mapped)", dllName, mapped.BaseAddress, mapped.DecoyModulePath);
